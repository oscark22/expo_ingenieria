<template>
    <div class="container text-center my-5">
        <h2>
            <strong>Rúbrica de categoría 2 de Software y Multimedia </strong>
        </h2>
    </div>
    ...
    <div class="row mb-3 mt-4">
        ...
        <div>
            <label for="gradeRange" class="form-label">Calificación: {{ grades.grade[16] }} ({{ grades.checkState(16) }})</label>
            <input v-model="grades.grade[16]" type="range" class="form-range" min="0" max="100" step="1" id="gradeRange">
        </div>
        </div>
        <div class="col-12 col-md-6 mt-3 mt-md-0">
            <p>
        ...
        <div>
            <label for="gradeRange" class="form-label">Calificación: {{ grades.grade[17] }} ({{ grades.checkState(17) }})</label>
            <input v-model="grades.grade[17]" type="range" class="form-range" min="0" max="100" step="1" id="gradeRange">
        </div>
        </div>
    </div>
    <div class="row mb-3 mt-4">
    ...
    <div class="row mb-3 mt-4">
        ...
        <div>
            <label for="gradeRange" class="form-label">Calificación: {{ grades.grade[15] }} ({{ grades.checkState(15) }})</label>
            <input v-model="grades.grade[15]" type="range" class="form-range" min="0" max="100" step="1" id="gradeRange">
        </div>
        </div>
    </div>
    <div>
    ...
    <button @click="grades.postSWM2()" class="btn btn-warning btn-lg mt-4" type="submit" data-bs-toggle="modal" data-bs-target="#projectModal">
        Enviar
    </button>
