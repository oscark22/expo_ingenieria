<template>
  <div class="container text-center pt-5 pt-md-4 mt-md-5">
    ...
    <div class="btn-group" role="group" aria-label="Basic outlined example">
      <button @click="fetchData(); activeBtn='btn1';" type="button" class="btn btn-primary">
      ...
      <button @click="fetchData(); activeBtn='btn3';" type="button" class="btn btn-success">
  ...
  <div class="container text-center mb-md-5 mb-5 pb-md-4 pb-3 mt-2">
    <template v-if="activeBtn==='btn2'">
      <div class="btn-group" role="group" aria-label="Basic outlined example">
        <button @click="fetchData()" type="button" class="btn btn-warning">
          Categoría I
        </button>
        <button @click="fetchData()" type="button" class="btn btn-dark">
          Categoría II
        </button>
      </div>
    </template>
